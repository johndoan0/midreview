...
var Restaurant = function(){
    // var self = this;
    this.getPrice = function(prop){return this.menu[prop]};
    // this.getDishes = function(){return Object.keys(this.menu)}
}

Restaurant.getDishes = function(){return Object.keys(this.menu)}
...
var pipeline = function(startVal,...callbacks){
    var value = startVal
...
// var getValues = function(arrofObjs, prop){
//     var propArr = []
//     for (var i = 0; i < arrofObjs.length; i++) {
//         propArr.push(arrofObjs[i][prop])
//     };
//     return propArr
// }

var getValues = function(arrofObjs, prop){
   var valArr = arrofObjs.map(function(obj){
    var val = obj[prop]
